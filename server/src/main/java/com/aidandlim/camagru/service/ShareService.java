...
public class ShareService {
    ...
    public String share(String id) {
        try {
            ...
            result += "<div style=\"width: 100%; height: calc(100vh - 142px); position: relative; float: left; background-size: contain; background-repeat: no-repeat; background-position: center; background-image: url(\'" + Const.URL + "api/picture?p=" + dto.getPicture() + "\')\"></div>";
